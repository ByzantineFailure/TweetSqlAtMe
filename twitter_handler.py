...
class TwitterHandler(object):
	def __init__(self, config_location, oauth_location):
...
def make_twitter_handler(config_location, oauth_location):
	return TwitterHandler(config_location, oauth_location);
